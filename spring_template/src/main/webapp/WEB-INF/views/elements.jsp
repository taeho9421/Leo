	...
	<div id="wrapper">
		...
		<div id="main">
			<div class="inner">
				...
				<!-- Header -->
				<header id="header">
					<a href="index" class="logo"><strong>Editorial</strong> by Pixelarity</a>
					<ul class="icons">
					...
					<div class="row gtr-200">
						...
						<div class="col-6 col-12-medium">
							...
							<span class="image fit"><img
								src="<spring:url value='/resources/images/pic11.jpg'/>"></span>
							<!-- <img src="images/pic11.jpg" alt="" /> -->
							<div class="box alt">
								<div class="row gtr-50 gtr-uniform">
									<div class="col-4">
										<span class="image fit"><img
											src="<spring:url value='/resources/images/pic01.jpg'/>"></span>
									</div>
									<div class="col-4">
										<span class="image fit"><img
											src="<spring:url value='/resources/images/pic02.jpg'/>"></span>
									</div>
									<div class="col-4">
										<span class="image fit"><img
											src="<spring:url value='/resources/images/pic03.jpg'/>"></span>
									</div>
									<!-- Break -->
									<div class="col-4">
										<span class="image fit"><img
									...
									<div class="col-4">
										<span class="image fit"><img
											src="<spring:url value='/resources/images/pic02.jpg'/>">
									</div>
									<div class="col-4">
										<span class="image fit"><img
											src="<spring:url value='/resources/images/pic03.jpg'/>"></span>
							...
							<p>
								<span class="image left"><img
									src="<spring:url value='/resources/images/pic01.jpg'/>"></span>Lorem
							...
							<p>
								<span class="image right"><img
									src="<spring:url value='/resources/images/pic02.jpg'/>"></span>Lorem
								ipsum dolor sit accumsan interdum nisi, quis tincidunt felis
								sagittis eget. tempus euismod. Vestibulum ante ipsum primis in
								faucibus vestibulum. Blandit adipiscing eu felis iaculis
								volutpat ac adipiscing accumsan eu faucibus. Integer ac
					...
					<div class="mini-posts">
						<article>
							<a href="#" class="image"><img
								src="<spring:url value='/resources/images/pic07.jpg'/>"></a>
							<p>Aenean ornare velit lacus, ac varius enim lorem
								ullamcorper dolore aliquam.</p>
						</article>
						<article>
							<a href="#" class="image"><img
								src="<spring:url value='/resources/images/pic08.jpg'/>"></a>
							<p>Aenean ornare velit lacus, ac varius enim lorem
								ullamcorper dolore aliquam.</p>
						</article>
						<article>
							<a href="#" class="image"><img
								src="<spring:url value='/resources/images/pic09.jpg'/>"></a>
							<p>Aenean ornare velit lacus, ac varius enim lorem
								ullamcorper dolore aliquam.</p>
						</article>
					</div>
