			...
			<div class="inner">
				...
				<section id="banner">
					<div class="content">
						<header>
							<h1>
								...
								by Pixelarity
								<!-- Hi, Iâm Editorial<br /> by Pixelarity -->
							</h1>
					...
					<span class="image object"> <img
						src="<spring:url value='/resources/images/pic10.jpg'/>"> <!-- <img src="images/pic10.jpg" alt="" /> -->
					</span>
				</section>
					...
					<div class="posts">
						<article>
							<a href="#" class="image"><img
								src="<spring:url value='/resources/images/pic01.jpg'/>"></a>
						...
						<article>
							<a href="#" class="image"><img
								src="<spring:url value='/resources/images/pic03.jpg'/>">
						...
						<article>
							<a href="#" class="image"><img
								src="<spring:url value='/resources/images/pic04.jpg'/>">
						...
						<article>
							<a href="#" class="image"><img
								src="<spring:url value='/resources/images/pic05.jpg'/>"></a>
						...
						<article>
							<a href="#" class="image"><img
								src="<spring:url value='/resources/images/pic06.jpg'/>"></a>
